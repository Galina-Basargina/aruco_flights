...
if __name__ == '__main__':
    ...
    # ---
    # каждое перемещение дрона, особенно на низкой скорости, приводит к накоплению статистической 
    # погрешности, которая составляет 20 см (см. комментарий выше)
    # команда дрону | на самом деле | погрешность | оценка до следующего маркера
    #           1.0             0.8           0.2                            1.2
    #           1.2             1.0           0.4                            1.2  
    #           1.2             1.0           0.6
    # то есть хотели перелететь на 3м (важно что трижды), и промазали на 60 см (трижды),
    # на самом деле низкая скорость - это всегда недолет, поэтому на низкой скорости 
    # погрешность накапливается быстрее
    # ---
    # возврат на 1й маркер с 4го - это погрешность 3*sqrt(0.2^2) + sqrt(40^2+20^2)
    # возврат на 3й меркер с 1го - это погрешность по х=40+20 см, по у=20 см
